...
def main():
    ...
    if dimension == 2:
        ...
        plt.scatter(data[:, 0], data[:, 1], edgecolors="magenta",
                    facecolor="None", label="data1")
        ...
        ax.scatter(data[:, 0], data[:, 1], data[:, 2], edgecolors="magenta",
                   facecolor="None", label="data2")
        ...
        plt.scatter(data_2d[:, 0], data_2d[:, 1], edgecolor="magenta",
                    facecolor="None", label="data2 in 2D")
        plt.xlim(-3, 3)
        plt.ylim(-1, 1)
        plt.xlabel("x1")
        plt.ylabel("x2")
        ...
        total_cont = np.array([np.sum(Cont_rate[:i]) for i in range(len(Cont_rate))])
