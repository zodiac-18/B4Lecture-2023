...
def f0_ACF(data:np.ndarray,sample_rate:int,size=100,overlap_r= 0.5) -> np.ndarray:
    ...
    Args:
        ...
        overlap_r (float, optional): overlap rate between frame and frame. Defaults to 0.5.
...
def f0_cep(data:np.ndarray, sample_rate:int, lif=50, size=100, overlap_r = 0.5)->np.ndarray:
