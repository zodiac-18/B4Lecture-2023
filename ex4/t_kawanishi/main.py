...
if __name__ == "__main__":
    #create parser
    parser = argparse.ArgumentParser(description="This is a program to estimate sound's Fundamental frequency and spectral envelop.")
    ...
    parser.add_argument(
        "-l", "--y_limit", help="limit of spectrogram's frequency", default=20000, type=int
    )
    parser.add_argument(
        "-d",
        "--degree",
